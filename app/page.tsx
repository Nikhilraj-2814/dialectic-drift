  ...
  return (
    <main className="min-h-screen bg-[#0B0F14] text-white overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-6 py-28 text-center">
        <p className="uppercase tracking-[0.35em] text-[#C9A227] mb-6 text-sm">
          Independent Journal of Ideas
        </p>
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-400 leading-relaxed">
          Essays on geopolitics, philosophy, history, technology and the forces
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 md:p-12">
          <p className="text-[#C9A227] uppercase tracking-widest text-sm mb-3">
            Featured Essay
          </p>
          ...
          <p className="text-gray-300 max-w-4xl leading-relaxed">
            ...
            power continuously evolves. Understanding those shifts is essential
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="rounded-3xl border border-[#C9A227]/30 p-10 text-center">
          ...
          <p className="text-gray-400 mb-6">
            Receive new essays and editorial notes directly in your inbox.
          </p>
          <button className="px-8 py-4 bg-[#C9A227] text-black rounded-xl font-semibold">
            Join Newsletter
          </button>
        </div>
      </section>
